        ...
        stage('Preparing Configurations'){
          steps {
            script{
                ...
                sh (returnStdout: true, script: "echo \"Get Calles Identity\"", label: "aws sts get-caller-identity")
                sh (returnStdout: true, script: "echo $(aws sts get-caller-identity)", label: "aws sts get-caller-identity")
